...
func NewRootCommand() *cobra.Command {
	...
	root.AddCommand(newOpenCommand(cfg))
	root.AddCommand(newSSHCommand(cfg, creds))
	root.AddCommand(newLogsCommand(cfg, creds))
	root.AddCommand(newTokenCommand(creds))
